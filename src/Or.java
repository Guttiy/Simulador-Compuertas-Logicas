...
public class Or extends Compuertas {
    ...
    public Or(int _identificador, Punto _pos){
        super(_identificador, 2, 1, _pos);
    } 
    
    public Or(String texto){
    ...
    public void dibujar(Graphics g) {
        g.drawLine(pos.x, pos.y+10, pos.x+24, pos.y+10);
        g.drawLine(pos.x, pos.y+30, pos.x+24, pos.y+30);
        g.drawArc(pos.x+20, pos.y, 5, 40, 0, 92);
        g.drawArc(pos.x+20, pos.y, 5, 40, 0, -92);
        g.drawLine(pos.x+70, pos.y+20, pos.x+90, pos.y+20);
        g.drawArc(pos.x-25, pos.y, 94, 40, 0, 92);
        g.drawArc(pos.x-25, pos.y, 94, 40, 0, -92);
        g.drawString("OR "+identificador, pos.x+27, pos.y+25);
    }

    @Override
    public String toString() {
        return 3+"/<"+identificador+";"+pos+";"+terminales+">";
    }
}
